...
public class ExceptionAdvice {
  ...
  public ResponseEntity<?> runtimeException(RuntimeException runtimeException) {
    ...
    ErrorResponse errorResponse = new ErrorResponse("Hatalı İşlem", details);
    return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<?> customInvalidFieldException(
      CustomInvalidFieldException customInvalidFieldException) {
    List<String> details = new ArrayList<>();
